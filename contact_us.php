...
$MailFromAddress = "admin@eracom"; // your email address
$MailToAddress = "projects@era-investment.com"; //  your email address
$redirectURL = ""; // the URL of the thank you page.
...
if (!$email) {$email = $MailToAddress;}
	...
	$mailHeader = "From: $MailFromAddress\r\n";
